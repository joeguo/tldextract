...
func TestAll(t *testing.T) {
	cases := map[string]*Result{"http://www.google.com": &Result{Flag:Domain, Sub:"www", Root:"google", Tld:"com"},
		...
		//".example.com":&Result{Flag:Malformed},
		//"example.example":&Result{Flag:Domain, Sub:"", Root:"example", Tld:"example"},
		//"b.example.example":&Result{Flag:Domain, Sub:"b", Root:"example", Tld:"example"},
		//"a.b.example.example":&Result{Flag:Domain, Sub:"a.b", Root:"example", Tld:"example"},
